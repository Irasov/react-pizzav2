    ...
    <div className="pizza-block-wrapper">
      <div className="pizza-block">
        ...
        <div className="pizza-block__selector">
          ...
          {
              types.map((type, i)=>(
                <li key={i} onClick={()=>{setIndexType(i)}} className={i === indexType ? "active":""}>{typesNames[type]}</li>
              ))
            }
          </ul>
          <ul>
            {
              sizes.map((size, i)=>(
                <li key={i} onClick={()=>{setIndexSize(i)}} className={i === indexSize ? "active":""}>{size} см.</li>
              ))
            }
          </ul>
        </div>
